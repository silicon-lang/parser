...
%param { silicon::parser::Context &ctx }
...
namespace yy
{
Parser::symbol_type yylex(silicon::parser::Context &ctx);
}
...
library
: global_statements { ctx.def_library($1); }
;
...
scope
: expression SEMICOLON { $$ = ctx.def_code_block({ $1 }); }
| OPEN_CURLY statements CLOSE_CURLY { $$ = ctx.def_code_block($2); }
;
...
expression
: RETURN value_ { $$ = ctx.def_return($2); }
| RETURN { $$ = ctx.def_return(); }
| BREAK { $$ = { ctx.def_break() }; }
...
| IDENTIFIER { $$ = ctx.def_variable($1); }
| value DOT IDENTIFIER { $$ = ctx.def_variable($3, $1); }
;
...
binary_operation
: value ASSIGN value_ { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, $3); }
| value STAR value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::STAR, $1, $3); }
| value SLASH value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::SLASH, $1, $3); }
| value PERCENT value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::PERCENT, $1, $3); }
| value PLUS value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::PLUS, $1, $3); }
| value MINUS value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::MINUS, $1, $3); }
| value CARET value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::CARET, $1, $3); }
| value AND value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::AND, $1, $3); }
| value OR value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::OR, $1, $3); }
| value STAR_STAR value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::STAR_STAR, $1, $3); }
| value DOUBLE_LESSER value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::DOUBLE_LESSER, $1, $3); }
| value DOUBLE_BIGGER value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::DOUBLE_BIGGER, $1, $3); }
| value TRIPLE_BIGGER value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::TRIPLE_BIGGER, $1, $3); }
| value STAR_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::STAR, $1, $3)); }
| value SLASH_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::SLASH, $1, $3)); }
| value PERCENT_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::PERCENT, $1, $3)); }
| value PLUS_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::PLUS, $1, $3)); }
| value MINUS_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::MINUS, $1, $3)); }
| value CARET_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::CARET, $1, $3)); }
| value STAR_STAR_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::STAR_STAR, $1, $3)); }
| value AND_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::AND, $1, $3)); }
| value OR_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::OR, $1, $3)); }
| value DOUBLE_LESSER_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::DOUBLE_LESSER, $1, $3)); }
| value DOUBLE_BIGGER_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::DOUBLE_BIGGER, $1, $3)); }
| value TRIPLE_BIGGER_ASSIGN value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, $1, ctx.def_op(silicon::parser::AST::binary_operation_t::TRIPLE_BIGGER, $1, $3)); }
| value AND_AND value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::AND_AND, $1, $3); }
| value OR_OR value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::OR_OR, $1, $3); }
| value LESSER value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::LESSER, $1, $3); }
| value LESSER_EQUAL value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::LESSER_EQUAL, $1, $3); }
| value EQUAL value { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::EQUAL, $1, $3); }
...
unary_operation
: value PLUS_PLUS { $$ = ctx.def_op(silicon::parser::AST::unary_operation_t::PLUS_PLUS, $1, true); }
| value MINUS_MINUS { $$ = ctx.def_op(silicon::parser::AST::unary_operation_t::MINUS_MINUS, $1, true); }
| PLUS_PLUS value %prec NOT { $$ = ctx.def_op(silicon::parser::AST::unary_operation_t::PLUS_PLUS, $2); }
| MINUS_MINUS value %prec NOT { $$ = ctx.def_op(silicon::parser::AST::unary_operation_t::MINUS_MINUS, $2); }
| AND value { $$ = ctx.def_op(silicon::parser::AST::unary_operation_t::AND, $2); }
| PLUS value %prec NOT { $$ = ctx.def_op(silicon::parser::AST::unary_operation_t::PLUS, $2); }
| MINUS value %prec NOT { $$ = ctx.def_op(silicon::parser::AST::unary_operation_t::MINUS, $2); }
| NOT value { $$ = ctx.def_op(silicon::parser::AST::unary_operation_t::NOT, $2); }
| TILDE value { $$ = ctx.def_op(silicon::parser::AST::unary_operation_t::TILDE, $2); }
;
...
//: IDENTIFIER ASSIGN value_ { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, ctx.def_variable_definition($1), $3); }
: IDENTIFIER COLON type ASSIGN value_ { $$ = ctx.def_op(silicon::parser::AST::binary_operation_t::ASSIGN, ctx.def_variable_definition($1, $3), $5); }
...
function_definition
: function_declaration OPEN_CURLY statements CLOSE_CURLY { $$ = ctx.def_fn($1, ctx.def_code_block($3)); }
;

function_declaration
: FUNCTION IDENTIFIER OPEN_PAREN arguments_definition CLOSE_PAREN COLON type { $$ = ctx.def_prototype($2, $4, $7); }
//| FUNCTION IDENTIFIER OPEN_PAREN arguments_definition CLOSE_PAREN { $$ = ctx.def_prototype($2, $4); }
;
...
function_call
: IDENTIFIER OPEN_PAREN arguments CLOSE_PAREN { $$ = ctx.def_fn_call($1, $3); }
;
...
plain_object
: OPEN_CURLY object_properties CLOSE_CURLY { $$ = ctx.def_plain_object($2); }
;
...
literal
: BOOLEAN_LITERAL { $$ = ctx.def_bool($1); }
| NUMBER_LITERAL { $$ = ctx.def_num($1); }
;
...
yy::Parser::symbol_type yy::yylex(silicon::parser::Context &ctx)
{
    ...
    {
      ctx.location.columns(ctx.cursor - anchor);

      return func(params..., ctx.location);
    };
